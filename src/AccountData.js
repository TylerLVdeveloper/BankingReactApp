const accountData = [
  {
    ...
    key: "0",
    transactions: [
      { id: 0, amount: 50, type: "Deposit", date: "02/20/2022" },
      { id: 1, amount: 500, type: "Deposit", date: "02/15/2022" },
      { id: 2, amount: 30, type: "Withdrawal", date: "02/15/2022" },
      { id: 3, amount: 20, type: "Transfer", date: "02/03/2022" },
    ],
  },
  {
    accountType: "Savings",
